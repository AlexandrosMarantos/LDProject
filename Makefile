...
CFLAGS = -O3 -Wall -g -msse4.2 #-DDEBUG #-D_IPOPCNT 

LIBRARIES = -lm 

EXECNAME = PatternMatch

OBJS = PM.o PM_SupportFunctions.o PM_CommandLine.o PM_ExecutionDetails.o PM_Input.o PM_PatternPool.o PM_Window.o PM_VCFParser.o PM_LinkageDisequilibrium.o PM_LDClass.o PM_Tries.o
...
PM_Tries.o:	PM_Tries.c
	$(CC) $(CFLAGS) -c PM_Tries.c
